...
check_package_apache2()
{
  ...
  echo_message $msg_level_info $msg_style_info "Apache2 installed: [$apache_installed] active: [$apache_active]"
...
check_package_mariadb()
{
  ...
  echo_message $msg_level_info $msg_style_info "MariaDB installed: [$mariadb_installed] active: [$mariadb_active]" 
...
check_package_php()
{
  ...
  echo_message $msg_level_info $msg_style_info "Checking PHP status..."

  # Get PHP information 
  php_get_status php_installed php_version

  echo_message $msg_level_info $msg_style_info "PHP installed: [$php_installed] version: [$php_version]"   
